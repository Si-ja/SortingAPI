namespace SortingAPI.Scripts.Sorters
{
    ...
    {
        /// <summary>
        /// Use a standard SelectionSort to rearrange your
        ...
        public static int[] Sort(int[] unsortedValues)
        {
            ...
            // Iterate through the values in the array looking for the smallest and replacing it positions wise
            for(int i=0; i < len-1; i++)
            {
                ...
                // Swap the first (or one we are dealing with sequentially) value with the smallest found in the array
